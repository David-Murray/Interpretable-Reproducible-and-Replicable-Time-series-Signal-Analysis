...
axs_1[1].add_patch(Ellipse((705730, 222),
        width=70,
        height=40,
        angle=-60,
        linewidth=1, fill=False))
axs_1[1].annotate('1.', xy=(705705, 200), xycoords='data', fontsize=12)
# Feature Area 2
axs_1[0].axvspan(705929, 705929+50, facecolor='0.5', alpha=0.25)
axs_1[0].annotate('2.', xy=(705929+5, 2000), xycoords='data')
axs_1[1].add_patch(Ellipse((705737, 482),
        width=45,
        height=35,
        angle=-60,
        linewidth=1, fill=False))
axs_1[1].annotate('2.', xy=(705735, 488), xycoords='data', fontsize=12)
# Feature Area 3
axs_1[0].axvspan(705831, 705850+75, facecolor='0.5', alpha=0.25)
axs_1[0].annotate('3.', xy=(705850+5, 2000), xycoords='data')
axs_1[1].add_patch(Ellipse((705710, 440),
        width=80,
        height=45,
        angle=-75,
        linewidth=1, fill=False))
axs_1[1].annotate('3.', xy=(705701, 445), xycoords='data', fontsize=12)


axs_1[1].set_xlabel("Sample", fontsize=13)
axs_1[1].set_ylabel("50 Sample Obsfucation\nStart Index", fontsize=13)
